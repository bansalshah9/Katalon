...
/*TotalTCV(){
	...
	String BasePrice = '1250'
	
	String Quantity= '6' 
	
	String ST =	 '36'
	
	TCV = BasePrice * Quantity * ST
	println(TCV)
   }
*/

basePrice ='USD 1,250.00'

 

BPLength = basePrice.toString().length()
...
int TCV
	 ...
	 ST = 12
				...
				STTemp = ST.toString().replace('.00000', '')
