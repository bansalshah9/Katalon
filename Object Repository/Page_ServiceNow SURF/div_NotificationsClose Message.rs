...
<WebElementEntity>
   ...
   <name>div_NotificationsClose Message</name>
   <tag></tag>
   <elementGuidId>ebce11e3-f88e-47d7-9760-85457727181e</elementGuidId>
   ...
   <webElementProperties>
      ...
      <name>text</name>
      <type>Main</type>
      <value>NotificationsClose Messages&quot;addRenderEvent(function() {CustomEvent.fire('glide_optics_inspect_update_watchfield', '');});Manage Attachments ():...addLoadEvent(function() {
	  ...
	  var h = new GlideEventHandler('updateChoiceList_u_base_currency', updateChoiceList_u_base_currency, 'sales_opportunity.account');
		  ...
		  ac.ajaxRequest();
			...
			})Renewal DetailsUSD Renewal ACV$USD Constant FX Renewal ACV$Renewal ACV$(USD)Renewal category-- None --Straight RenewalRenewal with UpsellRenewal with DownsellRenewal Status-- None --At Risk RenewalExpect To Lose RenewalEarly Renewal – Credit/ReplaceEarly Renewal – No CreditExtensionOverdue RenewalNoneStop Renewal NotificationSales OperationsflagsEdit flagsRemove selected itemView selected itemLockaddUnloadEvent(function() {
	    ...
	    var f = function() {
			...
			var list = new GlideList2('30511869db245344b73cd2c75e961900', 'u_sales_commission', '');
			...
			list.setProperties('');
			...
			list.setReferringURL(&quot;sales_opportunity.do?sys_id=-1@99@sysparm_stack=sales_opportunity_list.do&quot;);// save the data needed for submitting actions for related lists
				...
				list.setSubmitValue('sysparm_collectionID', 'f051d469db245344b73cd2c75e9619fc');
		  ...
		  if (typeof GlideList2 == &quot;undefined&quot;)
		    ...
		    f.call();Split CommissionShow ListSplit Commission First pagePrevious page
					to
					0
					of
					0Next pageLast page0Split CommissionSplit Commission
                  
            addLoadEvent(function() {new GlideWidgetVCR('b0511869db245344b73cd2c75e961900', '30511869db245344b73cd2c75e961900')})Hide List// setting 
			...
			CustomEvent.observe('table_wrap', function (trueFalse) {
				...
				setListTableWrap();
			});Edit table data inlineTable is in read modePersonalize ListActionsNumberSortOpp OwnerSortPercentage SplitSortNet New ACVSortSplit Opportunity LinkSortis Primary OwnerSortInsert a new row... Insert a new row...Bottom of tableTD.list_decoration {
			white-space: nowrap;
		}
		
		 SPAN.list_decoration_pad {
			padding-left: 1px;
		}addLoadEvent(function() {new GlideWidgetHideOnEmpty('e587f71ddba0534452d07bedae9619b2', '30511869db245344b73cd2c75e961900')})var list = GlideList2.get('30511869db245344b73cd2c75e961900');
...
addLoadEvent(function() { GlideList2.get('30511869db245344b73cd2c75e961900').loaded(); });
...
messages.set('(empty)');
			...
			editListRegisterOnSubmit('30511869db245344b73cd2c75e961900');
...
addOnSubmitEvent(thisForm, default_on_submit);
 ...
 glideUIElement.supportsMapping = false;
 g_form.addGlideUIElement(glideUIElement);
 var glideUIElement = new GlideUIElement('sales_opportunity', 'u_link_reason', 'string',false, 'null',null, 'global');
 glideUIElement.isInherited = false;
 glideUIElement.supportsMapping = false;
 g_form.addGlideUIElement(glideUIElement);
 ...
 glideUIElement.supportsMapping = false;
 g_form.addGlideUIElement(glideUIElement);
 var glideUIElement = new GlideUIElement('sales_opportunity', 'u_did_marketing_help', 'choice',false, 'null',null, 'global');
 glideUIElement.isInherited = false;
 glideUIElement.supportsMapping = false;
 g_form.addGlideUIElement(glideUIElement);
...
addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit08411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmit08411caddb645344b73cd2c75e961911,'onSubmit08411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmit08411caddb645344b73cd2c75e961911'] = 'Save Split Commission';g_event_handler_ids['onSubmit08411caddb645344b73cd2c75e961911'] = '2b5209be4f3e8a00e07d49cf0310c7c9';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit48411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmit48411caddb645344b73cd2c75e961911,'onSubmit48411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmit48411caddb645344b73cd2c75e961911'] = 'Check quote status on close of oppty';g_event_handler_ids['onSubmit48411caddb645344b73cd2c75e961911'] = '31773f8b4164250006ff035e3ab2ccca';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit88411caddb645344b73cd2c75e961911() { 
...
addOnSubmitEvent(thisForm, onSubmit88411caddb645344b73cd2c75e961911,'onSubmit88411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmit88411caddb645344b73cd2c75e961911'] = 'SSA Line item mandatory on submit';g_event_handler_ids['onSubmit88411caddb645344b73cd2c75e961911'] = '370bed098c99510006ff5e62ef64bb38';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');gFormAlreadySubmitted = false;
function onSubmitc8411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmitc8411caddb645344b73cd2c75e961911,'onSubmitc8411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmitc8411caddb645344b73cd2c75e961911'] = 'Set Meeting on submit';g_event_handler_ids['onSubmitc8411caddb645344b73cd2c75e961911'] = '6aba7c854f2f0e401f77a50f0310c78e';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit0c411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmit0c411caddb645344b73cd2c75e961911,'onSubmit0c411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmit0c411caddb645344b73cd2c75e961911'] = 'Check end date for upsell';g_event_handler_ids['onSubmit0c411caddb645344b73cd2c75e961911'] = '737e335f37d54200de6cd8d543990ed5';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit4c411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmit4c411caddb645344b73cd2c75e961911,'onSubmit4c411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmit4c411caddb645344b73cd2c75e961911'] = 'Check if opp onChange is processed';g_event_handler_ids['onSubmit4c411caddb645344b73cd2c75e961911'] = '8832dc1e6fc0f500188e360d5d3ee401';var messages = new GwtMessage();messages.set('This scripts make sure that the onChange of term is processes before the quote gets saved');addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit8c411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmit8c411caddb645344b73cd2c75e961911,'onSubmit8c411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmit8c411caddb645344b73cd2c75e961911'] = 'Check for valid Discount Price Per Seat';g_event_handler_ids['onSubmit8c411caddb645344b73cd2c75e961911'] = 'e5ba66810a0a3cba0166b5b719d53f84';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmitcc411caddb645344b73cd2c75e961911() {
...
addOnSubmitEvent(thisForm, onSubmitcc411caddb645344b73cd2c75e961911,'onSubmitcc411caddb645344b73cd2c75e961911');});g_event_handlers_onSubmit['onSubmitcc411caddb645344b73cd2c75e961911'] = 'Domain - Protect Scripts';g_event_handler_ids['onSubmitcc411caddb645344b73cd2c75e961911'] = 'f25a172aa84ba1b5007978515cdf6358';addRenderEvent( function() { var thisForm = document.getElementById('sales_opportunity.do');function onSubmit00411caddb645344b73cd2c75e961912() {
...
addOnSubmitEvent(thisForm, onSubmit00411caddb645344b73cd2c75e961912,'onSubmit00411caddb645344b73cd2c75e961912');});g_event_handlers_onSubmit['onSubmit00411caddb645344b73cd2c75e961912'] = 'SLS_Validte Stage in Renewal';g_event_handler_ids['onSubmit00411caddb645344b73cd2c75e961912'] = 'ff3838e3dbf932804ebcf3e51d9619ac';function onLoad_80411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_80411caddb645344b73cd2c75e961912, 'onLoad Set Order Form Status specific to SOPS','onLoad_80411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_80411caddb645344b73cd2c75e961912'] = 'Set Order Form Status specific to SOPS';g_event_handler_ids['onLoad_80411caddb645344b73cd2c75e961912'] = '05a9f62d3712f100de6cd8d543990e35';function onLoad_c0411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_c0411caddb645344b73cd2c75e961912, 'onLoad Restore related list timing','onLoad_c0411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_c0411caddb645344b73cd2c75e961912'] = 'Restore related list timing';g_event_handler_ids['onLoad_c0411caddb645344b73cd2c75e961912'] = '0e865fc4db11b6004ebcf3e51d961938';function onLoad_04411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_04411caddb645344b73cd2c75e961912, 'onLoad SSA Opportunity Form','onLoad_04411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_04411caddb645344b73cd2c75e961912'] = 'SSA Opportunity Form';g_event_handler_ids['onLoad_04411caddb645344b73cd2c75e961912'] = '0fdc28d6a10dc10006fff67c7cf67538';function onLoad_44411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_44411caddb645344b73cd2c75e961912, 'onLoad Remove AppStore related opty types','onLoad_44411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_44411caddb645344b73cd2c75e961912'] = 'Remove AppStore related opty types';g_event_handler_ids['onLoad_44411caddb645344b73cd2c75e961912'] = '1883bd487d65fd006f713577f68073f3';var messages = new GwtMessage();messages.set('Remove AppStore related opportunity types onLoad');function onLoad_84411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_84411caddb645344b73cd2c75e961912, 'onLoad setStageReadyOnly','onLoad_84411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_84411caddb645344b73cd2c75e961912'] = 'setStageReadyOnly';g_event_handler_ids['onLoad_84411caddb645344b73cd2c75e961912'] = '21764c3d13025600daf93227d144b0d2';var messages = new GwtMessage();messages.set('Set the stage as editable for saleOp when the stage is 8');function onLoad_c4411caddb645344b73cd2c75e961912() {
}
...
addRenderEventLogged(onLoad_c4411caddb645344b73cd2c75e961912, 'onLoad calcReturn','onLoad_c4411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_c4411caddb645344b73cd2c75e961912'] = 'calcReturn';g_event_handler_ids['onLoad_c4411caddb645344b73cd2c75e961912'] = '2bf56855a9fe156100d09e8a53b63ea9';function onLoad_08411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_08411caddb645344b73cd2c75e961912, 'onLoad Set contract status onload','onLoad_08411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_08411caddb645344b73cd2c75e961912'] = 'Set contract status onload';g_event_handler_ids['onLoad_08411caddb645344b73cd2c75e961912'] = '33cb5ab74d02810006ffcaf70b76822c';function onLoad_48411caddb645344b73cd2c75e961912() {
	if(g_form.getValue(&quot;type&quot;) == 'Renewal'){
...
addRenderEventLogged(onLoad_48411caddb645344b73cd2c75e961912, 'onLoad Update Renewal Category on Oppty','onLoad_48411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_48411caddb645344b73cd2c75e961912'] = 'Update Renewal Category on Oppty';g_event_handler_ids['onLoad_48411caddb645344b73cd2c75e961912'] = '38878a47dbe3d6004a54f4bbaf9619a6';function onLoad_88411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_88411caddb645344b73cd2c75e961912, 'onLoad Competition fields onLoad','onLoad_88411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_88411caddb645344b73cd2c75e961912'] = 'Competition fields onLoad';g_event_handler_ids['onLoad_88411caddb645344b73cd2c75e961912'] = '3f6ec08337d34a80b4ca1f7543990e48';var messages = new GwtMessage();messages.set('Set competition related fields onLoad');function onLoad_c8411caddb645344b73cd2c75e961912() {
	try {
		...
		console.log (&quot;Opportunity onLoad_c8411caddb645344b73cd2c75e961912 : Exception in Update Activity - onLoad_c8411caddb645344b73cd2c75e961912: &quot;+ e.message);
	}
}
function updateActivityWithIncreaseValue() {
	try {
		...
		console.log (&quot;Opportunity onLoad_c8411caddb645344b73cd2c75e961912 : Exception in Update Activity - updateActivityWithIncreaseValue: &quot;+ e.message);
	}
}
function updateActivityWithAddLine() {
	try {
		...
		console.log (&quot;Opportunity onLoad_c8411caddb645344b73cd2c75e961912 : Exception in Update Activity - updateActivityWithAddLine: &quot;+ e.message);
	}
}
...
addRenderEventLogged(onLoad_c8411caddb645344b73cd2c75e961912, 'onLoad Update Activity','onLoad_c8411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_c8411caddb645344b73cd2c75e961912'] = 'Update Activity';g_event_handler_ids['onLoad_c8411caddb645344b73cd2c75e961912'] = '466e0f4f132d1600ad02b2566144b028';var messages = new GwtMessage();messages.set('Update activity with its Meeting Update as \&quot;Accepted\&quot; if this opportunity is associated to Activity.\r', 'Update activity with its Meeting Update as \&quot;Accepted\&quot; if this opportunity is associated to Activity.');function onLoad_0c411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_0c411caddb645344b73cd2c75e961912, 'onLoad Check for Opportunity Creation','onLoad_0c411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_0c411caddb645344b73cd2c75e961912'] = 'Check for Opportunity Creation';g_event_handler_ids['onLoad_0c411caddb645344b73cd2c75e961912'] = '495237be4f1fc6401f77a50f0310c795';function onLoad_4c411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_4c411caddb645344b73cd2c75e961912, 'onLoad Hide AccntConsolidatn in Renewal Status','onLoad_4c411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_4c411caddb645344b73cd2c75e961912'] = 'Hide AccntConsolidatn in Renewal Status';g_event_handler_ids['onLoad_4c411caddb645344b73cd2c75e961912'] = '736fc995dbf6c300a3ab56a8dc961982';function onLoad_8c411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_8c411caddb645344b73cd2c75e961912, 'onLoad onLoad Default to Pre Negotiation','onLoad_8c411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_8c411caddb645344b73cd2c75e961912'] = 'onLoad Default to Pre Negotiation';g_event_handler_ids['onLoad_8c411caddb645344b73cd2c75e961912'] = '88605873370bf900b4ca1f7543990e25';function onLoad_cc411caddb645344b73cd2c75e961912() {
...
addRenderEventLogged(onLoad_cc411caddb645344b73cd2c75e961912, 'onLoad Hide Contract Type','onLoad_cc411caddb645344b73cd2c75e961912');g_event_handlers_onLoad['onLoad_cc411caddb645344b73cd2c75e961912'] = 'Hide Contract Type';g_event_handler_ids['onLoad_cc411caddb645344b73cd2c75e961912'] = '88d8926d4f2b4e40e07d49cf0310c7c5';function onLoad_00411caddb645344b73cd2c75e961913() {
...
addRenderEventLogged(onLoad_00411caddb645344b73cd2c75e961913, 'onLoad SSA Use Line Items OnLoad','onLoad_00411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_00411caddb645344b73cd2c75e961913'] = 'SSA Use Line Items OnLoad';g_event_handler_ids['onLoad_00411caddb645344b73cd2c75e961913'] = '90da25e760e6050006ff177ed89cae17';addRenderEventLogged(function() {
var onLoad_40411caddb645344b73cd2c75e961913 = (function(GlideAjax,g_form,GlideDialogWindow,GlideRecord,window,document,$,jQuery,$$,$j,$F,gel,undefined){
 &quot;use strict&quot;; 
function onLoad_40411caddb645344b73cd2c75e961913() {
   sessionStorage.setItem('disableButton', 'false');
}

 return onLoad_40411caddb645344b73cd2c75e961913.bind(null)})(ScopedGlideAjaxGenerator(&quot;x_snc_salescrm&quot;),ScopedGFormGenerator(&quot;x_snc_salescrm&quot;),ScopedGlideDialogWindowGenerator(&quot;x_snc_salescrm&quot;),null,null,null,null,null,null,null,null,null);
g_event_handlers_onLoad['onLoad_40411caddb645344b73cd2c75e961913'] = 'setSessionStorage';
g_event_handler_ids['onLoad_40411caddb645344b73cd2c75e961913'] = '9eb38cfedb19478089a4ff9aae961976';
onLoad_40411caddb645344b73cd2c75e961913();
},'setSessionStorage','onLoad_40411caddb645344b73cd2c75e961913');
addRenderEventLogged(function() {
var onLoad_80411caddb645344b73cd2c75e961913 = (function(GlideAjax,g_form,GlideDialogWindow,GlideRecord,window,document,$,jQuery,$$,$j,$F,gel,undefined){
 &quot;use strict&quot;; 
function onLoad_80411caddb645344b73cd2c75e961913() {
 ...
 return onLoad_80411caddb645344b73cd2c75e961913.bind(null)})(ScopedGlideAjaxGenerator(&quot;x_snc_salescrm&quot;),ScopedGFormGenerator(&quot;x_snc_salescrm&quot;),ScopedGlideDialogWindowGenerator(&quot;x_snc_salescrm&quot;),null,null,null,null,null,null,null,null,null);
g_event_handlers_onLoad['onLoad_80411caddb645344b73cd2c75e961913'] = 'Hide CPQ Quote Related List for AppStore';
g_event_handler_ids['onLoad_80411caddb645344b73cd2c75e961913'] = 'b34f1453db418b0089a4ff9aae9619ef';
onLoad_80411caddb645344b73cd2c75e961913();
},'Hide CPQ Quote Related List for AppStore','onLoad_80411caddb645344b73cd2c75e961913');
function onLoad_c0411caddb645344b73cd2c75e961913() {
...
addRenderEventLogged(onLoad_c0411caddb645344b73cd2c75e961913, 'onLoad Hide Currency codes with no price book','onLoad_c0411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_c0411caddb645344b73cd2c75e961913'] = 'Hide Currency codes with no price book';g_event_handler_ids['onLoad_c0411caddb645344b73cd2c75e961913'] = 'bf515d0960f8d9c006ff177ed89cae5a';function onLoad_04411caddb645344b73cd2c75e961913() {
	if(!g_form.getValue('account')) {
		return true;
	}
	var ga = new GlideAjax('SSAOpportunityAjax');
...
addRenderEventLogged(onLoad_04411caddb645344b73cd2c75e961913, 'onLoad Territory fields onLoad','onLoad_04411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_04411caddb645344b73cd2c75e961913'] = 'Territory fields onLoad';g_event_handler_ids['onLoad_04411caddb645344b73cd2c75e961913'] = 'bfb03f6c4fabca40e07d49cf0310c7c5';var messages = new GwtMessage();messages.set('Populate fields based on account if this is a new record');function onLoad_44411caddb645344b73cd2c75e961913() {
}
function generateAlert(title, message) {
	var gdw = new GlideDialogWindow('glide_warn', true);
	gdw.setTitle(title);
...
addRenderEventLogged(onLoad_44411caddb645344b73cd2c75e961913, 'onLoad Generate Alert','onLoad_44411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_44411caddb645344b73cd2c75e961913'] = 'Generate Alert';g_event_handler_ids['onLoad_44411caddb645344b73cd2c75e961913'] = 'c8b72971c3363000ad408039dfba8fc5';function onLoad_84411caddb645344b73cd2c75e961913() {
...
addRenderEventLogged(onLoad_84411caddb645344b73cd2c75e961913, 'onLoad Oppty Deal Reg fields Readonly rules','onLoad_84411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_84411caddb645344b73cd2c75e961913'] = 'Oppty Deal Reg fields Readonly rules';g_event_handler_ids['onLoad_84411caddb645344b73cd2c75e961913'] = 'cfac9fa7458011406f7173c5d352323c';function onLoad_c4411caddb645344b73cd2c75e961913() {
...
addRenderEventLogged(onLoad_c4411caddb645344b73cd2c75e961913, 'onLoad Secondary Deal Reg fields Readonly rules','onLoad_c4411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_c4411caddb645344b73cd2c75e961913'] = 'Secondary Deal Reg fields Readonly rules';g_event_handler_ids['onLoad_c4411caddb645344b73cd2c75e961913'] = 'd670fcdc37afb140b4ca1f7543990e36';function onLoad_08411caddb645344b73cd2c75e961913() {
...
addRenderEventLogged(onLoad_08411caddb645344b73cd2c75e961913, 'onLoad Add shark footer','onLoad_08411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_08411caddb645344b73cd2c75e961913'] = 'Add shark footer';g_event_handler_ids['onLoad_08411caddb645344b73cd2c75e961913'] = 'd7a267ba6f97a100188e360d5d3ee49c';function onLoad_48411caddb645344b73cd2c75e961913() {
	if(!g_form.isNewRecord()){
...
addRenderEventLogged(onLoad_48411caddb645344b73cd2c75e961913, 'onLoad Hide Did marketing help','onLoad_48411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_48411caddb645344b73cd2c75e961913'] = 'Hide Did marketing help';g_event_handler_ids['onLoad_48411caddb645344b73cd2c75e961913'] = 'e5f510b3db2b8740a3ab56a8dc961902';function onLoad_88411caddb645344b73cd2c75e961913() {
...
addRenderEventLogged(onLoad_88411caddb645344b73cd2c75e961913, 'onLoad Data Center Customized Choices','onLoad_88411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_88411caddb645344b73cd2c75e961913'] = 'Data Center Customized Choices';g_event_handler_ids['onLoad_88411caddb645344b73cd2c75e961913'] = 'e61ed73f1388a2007b9e38fed144b078';function onLoad_c8411caddb645344b73cd2c75e961913() {
  var isSalesOps = g_user.hasRole('sales_operations');
...
addRenderEventLogged(onLoad_c8411caddb645344b73cd2c75e961913, 'onLoad Remove close lost option on renewals','onLoad_c8411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_c8411caddb645344b73cd2c75e961913'] = 'Remove close lost option on renewals';g_event_handler_ids['onLoad_c8411caddb645344b73cd2c75e961913'] = 'ea95ab12e4aaa4006f7199fd507ebbaf';function onLoad_0c411caddb645344b73cd2c75e961913() {
	var i=0;
...
addRenderEventLogged(onLoad_0c411caddb645344b73cd2c75e961913, 'onLoad Display Button for link Submit Summary','onLoad_0c411caddb645344b73cd2c75e961913');g_event_handlers_onLoad['onLoad_0c411caddb645344b73cd2c75e961913'] = 'Display Button for link Submit Summary';g_event_handler_ids['onLoad_0c411caddb645344b73cd2c75e961913'] = 'ed95a10413a96a80e0dcb2566144b0fb';
...
function createBreakDown(tables,table,field){
    ...
    g_form.addInfoMessage('&lt;span class=&quot;icon icon-loading&quot;>&lt;/span> Breakdown being created...');
...
}gcm.addHref(&quot;Sync Apttus Quote&quot;, &quot;gsftSubmit(gel('b98a8ccbdb8e4f803f377bedae9619c6'))&quot;, null, &quot;&quot;, null, &quot;&quot;);var mModify = new GwtContextMenu('context_modifysuba6285ceddb84ae4466d8f4bbaf961915');
        ...
        mExport.clear();
        mExport.addURL(&quot;PDF (Portrait)&quot;, &quot;sales_opportunity.do?sys_id=f051d469db245344b73cd2c75e9619fc&amp;PDF&amp;sysparm_view=&quot;);
	mExport.addURL(&quot;PDF (Landscape)&quot;, &quot;sales_opportunity.do?sys_id=f051d469db245344b73cd2c75e9619fc&amp;PDF&amp;landscape=true&amp;sysparm_view=&quot;);
        mExport.addURL(&quot;XML (This Record)&quot;, &quot;sales_opportunity.do?UNL&amp;sysparm_query=sys_id=f051d469db245344b73cd2c75e9619fc&quot;);gcm.addMenu(&quot;Export&quot;, mExport);gcm.addLine();
		
		  
		  
		    gcm.addHref(&quot;Copy URL&quot;, &quot;copyToClipboard('https://surfqa5.service-now.com/nav_to.do?uri=sales_opportunity.do?sys_id=f051d469db245344b73cd2c75e9619fc');&quot;);
		  

		gcm.addHref(&quot;Copy sys_id&quot;, &quot;copyToClipboard('f051d469db245344b73cd2c75e9619fc');&quot;);
			gcm.addHref(&quot;Show XML&quot;, &quot;xmlView('sales_opportunity', 'f051d469db245344b73cd2c75e9619fc');&quot;);gcm.addHref(&quot;Reload form&quot;, &quot;reloadWindow(window);&quot;);g_related_list_timing = 'ondemand';The End Of No, The Beginning of Now!© 2014 ServiceNow. All rights reservedResponse time(ms)
         Response time(ms): 2755, Network: 8, server: 2155, browser: 592Toggle browser timing details  DUPLICATE WARNING:  One of these opportunities may be a duplicate.  Select the opportunity or click continue to create new opportunity./* dialog styles */
.dialog_content {
width: 400px;
height: 100px;
...
// create the GlideList2 object for this list
var list = new GlideList2('list_opportunity', 'sales_opportunity', 'stageNOT INclosed_won,closed_lost,closed_no_decision,sops_admin^typeIN new_business,Renewal,Module Upsell,License Upsell^account=8fc3f7ae0a0a3cba019da3d205ede759');
list.setListName('Opportunity');
list.setFields('number,name,account,active,allowable_discount_level,close_date,double_compensation_overlay,expected_date,flags,maximum_discount');
list.setTitle('Opportunity');
list.setListControlID('41fc00148041f800e88d10ff5437aa94');
list.setProperties('');
// pass order by, since it can come from sources other than the query string
            list.setOrderBy('');
            
// save the data that we will need to refresh the list
list.setView('opportunity');
...
list.setSubmitValue('sysparm_target', '');
            ...
            if ('')
            list.setSubmitValue('sysparm_query_no_domain', '');
list.setReferringURL(&quot;sales_opportunity.do?sys_id=-1@99@sysparm_stack=sales_opportunity_list.do&quot;);list.handlePrint(true);list = null;
  };
  ...
  addLoadEvent(f);
    ...
    f.call();// setting 
			...
			CustomEvent.observe('table_wrap', function (trueFalse) {
				window.NOW.listTableWrap = trueFalse; 
				setListTableWrap();
			});Edit table data inlinePersonalize ListActionsNumberSortNameSortAccountSortActiveSortAllowable Discount LevelSortClose dateSortDouble Compensation OverlaySortExpected dateSortflagsSortMaximum Discount (Percent)SortSelectPreviewOPTY0742361zzzzJohnson &amp; Johnsontrue2017-12-29SelectPreviewOPTY0742969TestOppJohnson &amp; Johnsontrue2017-12-20SelectPreviewOPTY0745748Test OppJohnson &amp; Johnsontrue2018-01-09First Time Purchase, UpsellSelectPreviewOPTY0743050Test OppJohnson &amp; Johnsontrue2017-12-21SelectPreviewOPTY0747778test ISV managerJohnson &amp; Johnsontrue2018-01-31SelectPreviewOPTY0747796test issue harshJohnson &amp; Johnsontrue2018-01-22SelectPreviewOPTY0753025testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753040testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753015testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753027testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0752968testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753017testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753035testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753030testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753039testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0752976testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0751146testJohnson &amp; Johnsontrue2018-02-12First Time PurchaseSelectPreviewOPTY0753020testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0753016testJohnson &amp; Johnsontrue2018-02-27SelectPreviewOPTY0752949testJohnson &amp; Johnsontrue2018-02-27Bottom of tableTD.list_decoration {
white-space: nowrap;
}
 SPAN.list_decoration_pad {
padding-left: 1px;
}First pagePrevious pageShowing rows 1 to 20 of 149
to
20
of
149Next pageLast page0OpportunityOpportunity
                  
            addLoadEvent(function() {new GlideWidgetVCR('2061d0eddb645344b73cd2c75e9619e1', 'list_opportunity')})addLoadEvent(function() {new GlideWidgetHideOnEmpty('1061d0eddb645344b73cd2c75e9619b8', 'list_opportunity')})var list = GlideList2.get('list_opportunity');
list.titleMenu.clear();list.titleMenu.add('216ac28a0a0a0bb200af43eb879c30ae','216ac28a0a0a0bb200af43eb879c30ae','','Refresh List','action','','1000','','true');
    list.titleMenu.add('385356ad0a0a0b7c00b3d75ea03e5eb4','385356ad0a0a0b7c00b3d75ea03e5eb4','','Show','menu','','990','','true');
    list.titleMenu.add('b16a46bd0a0a0bbb007f8195366a63c0','','b169dd7f0a0a0bbb0062fb97a5ea1e1c','ADR Marketing InsideSales','action','changeView(\'adr_marketing_insidesales\')','0','','false');
    list.titleMenu.add('b16a46bd0a0a0bbb007f8195366a63c0','','b169dd7f0a0a0bbb0062fb97a5ea1e1c','Default view','action','','1','images/checked.pngx','false');
    list.titleMenu.add('b16a46bd0a0a0bbb007f8195366a63c0','','b169dd7f0a0a0bbb0062fb97a5ea1e1c','Opportunity','action','changeView(\'opportunity\')','2','','false');
    list.titleMenu.add('b16a46bd0a0a0bbb007f8195366a63c0','','b169dd7f0a0a0bbb0062fb97a5ea1e1c','Scrum','action','changeView(\'Scrum\')','3','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','--none--','b16a5dbe0a0a0bbb00043b7b284050b6','-- None --','action','groupList(\'\');','0','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_isr_interaction','b16a5dbe0a0a0bbb00043b7b284050b6','ADR Interaction','action','groupList(\'u_isr_interaction\');','1','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','account','b16a5dbe0a0a0bbb00043b7b284050b6','Account','action','groupList(\'account\');','2','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','active','b16a5dbe0a0a0bbb00043b7b284050b6','Active','action','groupList(\'active\');','3','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','x_snc_salescrm_agreement','b16a5dbe0a0a0bbb00043b7b284050b6','Agreement','action','groupList(\'x_snc_salescrm_agreement\');','4','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','allowable_discount_level','b16a5dbe0a0a0bbb00043b7b284050b6','Allowable Discount Level','action','groupList(\'allowable_discount_level\');','5','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_runtime_licenses_opportunity','b16a5dbe0a0a0bbb00043b7b284050b6','AppStore Runtime License','action','groupList(\'u_runtime_licenses_opportunity\');','6','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_credit_card_transaction_id','b16a5dbe0a0a0bbb00043b7b284050b6','AppStore Transaction ID','action','groupList(\'u_credit_card_transaction_id\');','7','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_approval_territory','b16a5dbe0a0a0bbb00043b7b284050b6','Approval Territory','action','groupList(\'u_approval_territory\');','8','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_approved_discount_seats','b16a5dbe0a0a0bbb00043b7b284050b6','Approved discount seats','action','groupList(\'u_approved_discount_seats\');','9','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_approved_discount_servers','b16a5dbe0a0a0bbb00043b7b284050b6','Approved discount servers','action','groupList(\'u_approved_discount_servers\');','10','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_auto_split','b16a5dbe0a0a0bbb00043b7b284050b6','Auto Split','action','groupList(\'u_auto_split\');','11','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_base_currency','b16a5dbe0a0a0bbb00043b7b284050b6','Base currency','action','groupList(\'u_base_currency\');','12','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_business_unit_for_lump_sum_forecast','b16a5dbe0a0a0bbb00043b7b284050b6','Business Unit (for lump sum forecast)','action','groupList(\'u_business_unit_for_lump_sum_forecast\');','13','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_campaign_history','b16a5dbe0a0a0bbb00043b7b284050b6','Campaign History','action','groupList(\'u_campaign_history\');','14','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_gsi_product_offering','b16a5dbe0a0a0bbb00043b7b284050b6','Catalyst Program','action','groupList(\'u_gsi_product_offering\');','15','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_gsi_product','b16a5dbe0a0a0bbb00043b7b284050b6','Catalyst Solution','action','groupList(\'u_gsi_product\');','16','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_from_express_ar','b16a5dbe0a0a0bbb00043b7b284050b6','Change from Express AR','action','groupList(\'u_from_express_ar\');','17','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_campaign_name','b16a5dbe0a0a0bbb00043b7b284050b6','Channel Event Campaign','action','groupList(\'u_campaign_name\');','18','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sys_class_name','b16a5dbe0a0a0bbb00043b7b284050b6','Class','action','groupList(\'sys_class_name\');','19','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_close_date___date_dimension','b16a5dbe0a0a0bbb00043b7b284050b6','Close Date - Date Dimension','action','groupList(\'u_close_date___date_dimension\');','20','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_close_month','b16a5dbe0a0a0bbb00043b7b284050b6','Close month','action','groupList(\'u_close_month\');','21','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sales_quarter','b16a5dbe0a0a0bbb00043b7b284050b6','Close quarter','action','groupList(\'u_sales_quarter\');','22','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_closed_at_exchange_rate','b16a5dbe0a0a0bbb00043b7b284050b6','Closed at exchange rate','action','groupList(\'u_closed_at_exchange_rate\');','23','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_commission_exception','b16a5dbe0a0a0bbb00043b7b284050b6','Commission Exception','action','groupList(\'u_commission_exception\');','24','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_competitive_reason','b16a5dbe0a0a0bbb00043b7b284050b6','Competitive Reason','action','groupList(\'u_competitive_reason\');','25','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_competitive_status','b16a5dbe0a0a0bbb00043b7b284050b6','Competitive Status','action','groupList(\'u_competitive_status\');','26','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_consolidated_discount','b16a5dbe0a0a0bbb00043b7b284050b6','Consolidated Discount','action','groupList(\'u_consolidated_discount\');','27','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_constant_fx_rate','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Rate','action','groupList(\'u_constant_fx_rate\');','28','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_constant_fiscal_year','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Rate Effective Year','action','groupList(\'u_constant_fiscal_year\');','29','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_renewal_acv_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Renewal ACV USD','action','groupList(\'u_renewal_acv_const\');','30','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_license_val_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl License Value USD','action','groupList(\'u_ssa_rollup_license_val_usd_const\');','31','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_netnewacv_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl Net New ACV USD','action','groupList(\'u_ssa_rollup_netnewacv_usd_const\');','32','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_other_rev_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl Other Revenue USD','action','groupList(\'u_ssa_rollup_other_rev_usd_const\');','33','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_serv_rev_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl PS Revenue USD','action','groupList(\'u_ssa_rollup_serv_rev_usd_const\');','34','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_ttl_serv_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl Services Revenue USD','action','groupList(\'u_ssa_rollup_ttl_serv_usd_const\');','35','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_acv_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl Subscription ACV USD','action','groupList(\'u_ssa_rollup_acv_usd_const\');','36','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_train_rev_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl Training Revenue USD','action','groupList(\'u_ssa_rollup_train_rev_usd_const\');','37','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_netnewacv_w_usd_const','b16a5dbe0a0a0bbb00043b7b284050b6','Constant FX Ttl Weighted ACV USD','action','groupList(\'u_ssa_rollup_netnewacv_w_usd_const\');','38','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_contract','b16a5dbe0a0a0bbb00043b7b284050b6','Contract','action','groupList(\'u_contract\');','39','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_contract_type','b16a5dbe0a0a0bbb00043b7b284050b6','Contract Type','action','groupList(\'u_contract_type\');','40','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_express_conversion','b16a5dbe0a0a0bbb00043b7b284050b6','Conversion','action','groupList(\'u_express_conversion\');','41','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sys_created_by','b16a5dbe0a0a0bbb00043b7b284050b6','Created by','action','groupList(\'sys_created_by\');','42','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_credit_card_order','b16a5dbe0a0a0bbb00043b7b284050b6','Credit Card Order','action','groupList(\'u_credit_card_order\');','43','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_data_center','b16a5dbe0a0a0bbb00043b7b284050b6','Data center','action','groupList(\'u_data_center\');','44','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_dedicated_server','b16a5dbe0a0a0bbb00043b7b284050b6','Dedicated server','action','groupList(\'u_dedicated_server\');','45','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_deployment_registration_number','b16a5dbe0a0a0bbb00043b7b284050b6','Deployment Registration Number','action','groupList(\'u_deployment_registration_number\');','46','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_did_marketing_help','b16a5dbe0a0a0bbb00043b7b284050b6','Did Marketing Help?','action','groupList(\'u_did_marketing_help\');','47','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_discount_percent_seats','b16a5dbe0a0a0bbb00043b7b284050b6','Discount % seats','action','groupList(\'u_discount_percent_seats\');','48','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_discount_percent_servers','b16a5dbe0a0a0bbb00043b7b284050b6','Discount % servers','action','groupList(\'u_discount_percent_servers\');','49','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_discount_percent','b16a5dbe0a0a0bbb00043b7b284050b6','Discount percent','action','groupList(\'u_discount_percent\');','50','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_discount_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','Discount price per seat','action','groupList(\'u_discount_price_per_seat\');','51','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_discount_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','Discount price per server','action','groupList(\'u_discount_price_per_server\');','52','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sys_domain','b16a5dbe0a0a0bbb00043b7b284050b6','Domain','action','groupList(\'sys_domain\');','53','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sys_domain_path','b16a5dbe0a0a0bbb00043b7b284050b6','Domain Path','action','groupList(\'sys_domain_path\');','54','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','double_compensation_overlay','b16a5dbe0a0a0bbb00043b7b284050b6','Double Compensation Overlay','action','groupList(\'double_compensation_overlay\');','55','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_education_isr','b16a5dbe0a0a0bbb00043b7b284050b6','Education ISR','action','groupList(\'u_education_isr\');','56','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_end_customer','b16a5dbe0a0a0bbb00043b7b284050b6','End Customer','action','groupList(\'u_end_customer\');','57','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_logo_override','b16a5dbe0a0a0bbb00043b7b284050b6','Enterprise Logo Override','action','groupList(\'u_logo_override\');','58','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_new_logo','b16a5dbe0a0a0bbb00043b7b284050b6','Enterprise New Logo','action','groupList(\'u_new_logo\');','59','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_express_logo_override','b16a5dbe0a0a0bbb00043b7b284050b6','Express Logo Override','action','groupList(\'u_express_logo_override\');','60','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_express_new_logo','b16a5dbe0a0a0bbb00043b7b284050b6','Express New Logo','action','groupList(\'u_express_new_logo\');','61','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','owner','b16a5dbe0a0a0bbb00043b7b284050b6','Field Sales','action','groupList(\'owner\');','62','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_territory','b16a5dbe0a0a0bbb00043b7b284050b6','Field Territory','action','groupList(\'u_territory\');','63','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_final_order_form_output','b16a5dbe0a0a0bbb00043b7b284050b6','Final Order Form Output','action','groupList(\'u_final_order_form_output\');','64','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_first_closed_by','b16a5dbe0a0a0bbb00043b7b284050b6','First Closed By','action','groupList(\'u_first_closed_by\');','65','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','pipeline_status','b16a5dbe0a0a0bbb00043b7b284050b6','Forecast Category','action','groupList(\'pipeline_status\');','66','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','stage','b16a5dbe0a0a0bbb00043b7b284050b6','Forecast Stage','action','groupList(\'stage\');','67','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_forecast_type','b16a5dbe0a0a0bbb00043b7b284050b6','Forecast Type','action','groupList(\'u_forecast_type\');','68','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_forecast_type_override','b16a5dbe0a0a0bbb00043b7b284050b6','Forecast Type Override','action','groupList(\'u_forecast_type_override\');','69','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_forecast_lump_sum_nnacv','b16a5dbe0a0a0bbb00043b7b284050b6','Forecast lump sum NNACV','action','groupList(\'u_forecast_lump_sum_nnacv\');','70','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_fx_rate_string','b16a5dbe0a0a0bbb00043b7b284050b6','Fx rate','action','groupList(\'u_fx_rate_string\');','71','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_gross_acv','b16a5dbe0a0a0bbb00043b7b284050b6','Gross ACV','action','groupList(\'u_gross_acv\');','72','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_gross_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','Gross price per seat','action','groupList(\'u_gross_price_per_seat\');','73','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_gross_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','Gross price per server','action','groupList(\'u_gross_price_per_server\');','74','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ha_dr','b16a5dbe0a0a0bbb00043b7b284050b6','HA/DR','action','groupList(\'u_ha_dr\');','75','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_hr_sales_specialist','b16a5dbe0a0a0bbb00043b7b284050b6','HR Sales Specialist(Do Not Use)','action','groupList(\'u_hr_sales_specialist\');','76','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_has_future_upsell','b16a5dbe0a0a0bbb00043b7b284050b6','Has Future Upsell','action','groupList(\'u_has_future_upsell\');','77','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_specialist_overlay','b16a5dbe0a0a0bbb00043b7b284050b6','ITOM Sales Specialist(Do Not Use)','action','groupList(\'u_specialist_overlay\');','78','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_imported_from_hi','b16a5dbe0a0a0bbb00043b7b284050b6','Imported from HI','action','groupList(\'u_imported_from_hi\');','79','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_incumbent','b16a5dbe0a0a0bbb00043b7b284050b6','Incumbent','action','groupList(\'u_incumbent\');','80','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_inside_sales_rep','b16a5dbe0a0a0bbb00043b7b284050b6','Inside Sales Rep','action','groupList(\'u_inside_sales_rep\');','81','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_integration_record','b16a5dbe0a0a0bbb00043b7b284050b6','Integration Record','action','groupList(\'u_integration_record\');','82','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_integration_table','b16a5dbe0a0a0bbb00043b7b284050b6','Integration Table','action','groupList(\'u_integration_table\');','83','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_lead_number','b16a5dbe0a0a0bbb00043b7b284050b6','Lead Number','action','groupList(\'u_lead_number\');','84','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_lead_source','b16a5dbe0a0a0bbb00043b7b284050b6','Lead Source','action','groupList(\'u_lead_source\');','85','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_msp','b16a5dbe0a0a0bbb00043b7b284050b6','MSP Partner','action','groupList(\'u_msp\');','86','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_msp_sales','b16a5dbe0a0a0bbb00043b7b284050b6','MSP Sales','action','groupList(\'u_msp_sales\');','87','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_msp_territory','b16a5dbe0a0a0bbb00043b7b284050b6','MSP Territory','action','groupList(\'u_msp_territory\');','88','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_master_quote','b16a5dbe0a0a0bbb00043b7b284050b6','Master Quote(u_master_quote)','action','groupList(\'u_master_quote\');','89','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','x_snc_salescrm_cpq_quote','b16a5dbe0a0a0bbb00043b7b284050b6','Master Quote(x_snc_salescrm_cpq_quote)','action','groupList(\'x_snc_salescrm_cpq_quote\');','90','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_value_promter_master','b16a5dbe0a0a0bbb00043b7b284050b6','Master Value Prompter','action','groupList(\'u_value_promter_master\');','91','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_matrix_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','Matrix price per seat','action','groupList(\'u_matrix_price_per_seat\');','92','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_matrix_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','Matrix price per server','action','groupList(\'u_matrix_price_per_server\');','93','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_approval_discount','b16a5dbe0a0a0bbb00043b7b284050b6','Max Discount (%)','action','groupList(\'u_approval_discount\');','94','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','maximum_discount','b16a5dbe0a0a0bbb00043b7b284050b6','Maximum Discount (Percent)','action','groupList(\'maximum_discount\');','95','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_meeting_display_flag','b16a5dbe0a0a0bbb00043b7b284050b6','Meeting Display Flag','action','groupList(\'u_meeting_display_flag\');','96','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_meeting_id','b16a5dbe0a0a0bbb00043b7b284050b6','Meeting Number','action','groupList(\'u_meeting_id\');','97','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','name','b16a5dbe0a0a0bbb00043b7b284050b6','Name','action','groupList(\'name\');','98','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_net_new_acv_d','b16a5dbe0a0a0bbb00043b7b284050b6','Net new ACV','action','groupList(\'u_net_new_acv_d\');','99','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_net_new_seats','b16a5dbe0a0a0bbb00043b7b284050b6','Net new seats','action','groupList(\'u_net_new_seats\');','100','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_net_new_servers','b16a5dbe0a0a0bbb00043b7b284050b6','Net new servers','action','groupList(\'u_net_new_servers\');','101','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_net_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','Net price per seat','action','groupList(\'u_net_price_per_seat\');','102','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_net_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','Net price per server','action','groupList(\'u_net_price_per_server\');','103','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_notification_rule','b16a5dbe0a0a0bbb00043b7b284050b6','Notification Rule','action','groupList(\'u_notification_rule\');','104','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','number','b16a5dbe0a0a0bbb00043b7b284050b6','Number','action','groupList(\'number\');','105','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_number_of_seats','b16a5dbe0a0a0bbb00043b7b284050b6','Number of seats','action','groupList(\'u_number_of_seats\');','106','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_number_of_servers','b16a5dbe0a0a0bbb00043b7b284050b6','Number of servers','action','groupList(\'u_number_of_servers\');','107','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_offsetting_opportunity','b16a5dbe0a0a0bbb00043b7b284050b6','Offsetting Opportunity','action','groupList(\'u_offsetting_opportunity\');','108','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_opportunity_link_reason','b16a5dbe0a0a0bbb00043b7b284050b6','Opportunity Link Reason','action','groupList(\'u_opportunity_link_reason\');','109','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_opportunity_source','b16a5dbe0a0a0bbb00043b7b284050b6','Opportunity Source','action','groupList(\'u_opportunity_source\');','110','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','type','b16a5dbe0a0a0bbb00043b7b284050b6','Opportunity Type','action','groupList(\'type\');','111','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_option_self_hosted_w_o_sig_penalty','b16a5dbe0a0a0bbb00043b7b284050b6','Option Self-Hosted w/o Sig. penalty','action','groupList(\'u_option_self_hosted_w_o_sig_penalty\');','112','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_order_form_output_reason','b16a5dbe0a0a0bbb00043b7b284050b6','Order Form Output Reason','action','groupList(\'u_order_form_output_reason\');','113','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_contract_status','b16a5dbe0a0a0bbb00043b7b284050b6','Order Form Status','action','groupList(\'u_contract_status\');','114','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_order_term_days','b16a5dbe0a0a0bbb00043b7b284050b6','Order Term Days','action','groupList(\'u_order_term_days\');','115','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_other_competitor','b16a5dbe0a0a0bbb00043b7b284050b6','Other Competitor','action','groupList(\'u_other_competitor\');','116','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_other_discount','b16a5dbe0a0a0bbb00043b7b284050b6','Other discount','action','groupList(\'u_other_discount\');','117','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_other_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','Other revenue','action','groupList(\'u_other_revenue\');','118','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_overlay_isr','b16a5dbe0a0a0bbb00043b7b284050b6','Overlay ADR','action','groupList(\'u_overlay_isr\');','119','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_snot','b16a5dbe0a0a0bbb00043b7b284050b6','Overlay SC','action','groupList(\'u_snot\');','120','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_pa_sales_specialist','b16a5dbe0a0a0bbb00043b7b284050b6','PA Sales Specialist(Do Not Use)','action','groupList(\'u_pa_sales_specialist\');','121','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ps_teaming','b16a5dbe0a0a0bbb00043b7b284050b6','PS Teaming','action','groupList(\'u_ps_teaming\');','122','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ps_territory','b16a5dbe0a0a0bbb00043b7b284050b6','PS Territory','action','groupList(\'u_ps_territory\');','123','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_implementation_partner','b16a5dbe0a0a0bbb00043b7b284050b6','PS Vendor','action','groupList(\'u_implementation_partner\');','124','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_tbd','b16a5dbe0a0a0bbb00043b7b284050b6','PS Vendor TBD','action','groupList(\'u_tbd\');','125','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ps_recognizable_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','PS recognizable revenue','action','groupList(\'u_ps_recognizable_revenue\');','126','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ps_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','PS revenue','action','groupList(\'u_ps_revenue\');','127','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_parent','b16a5dbe0a0a0bbb00043b7b284050b6','Parent','action','groupList(\'u_parent\');','128','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_partner_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Partner Revenue','action','groupList(\'u_ssa_rollup_partner_amount\');','129','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','partner_percent','b16a5dbe0a0a0bbb00043b7b284050b6','Partner percent','action','groupList(\'partner_percent\');','130','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_partnered','b16a5dbe0a0a0bbb00043b7b284050b6','Partnered','action','groupList(\'u_partnered\');','131','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_payment_schedule','b16a5dbe0a0a0bbb00043b7b284050b6','Payment Schedule','action','groupList(\'u_payment_schedule\');','132','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','price_band','b16a5dbe0a0a0bbb00043b7b284050b6','Price Band','action','groupList(\'price_band\');','133','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_price_book','b16a5dbe0a0a0bbb00043b7b284050b6','Price Book','action','groupList(\'u_price_book\');','134','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_primary_competitor','b16a5dbe0a0a0bbb00043b7b284050b6','Primary Competitor','action','groupList(\'u_primary_competitor\');','135','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','probability','b16a5dbe0a0a0bbb00043b7b284050b6','Probability','action','groupList(\'probability\');','136','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','probability_percent','b16a5dbe0a0a0bbb00043b7b284050b6','Probability percent','action','groupList(\'probability_percent\');','137','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','product','b16a5dbe0a0a0bbb00043b7b284050b6','Product','action','groupList(\'product\');','138','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_product_technology_partner','b16a5dbe0a0a0bbb00043b7b284050b6','Product Technology Partner','action','groupList(\'u_product_technology_partner\');','139','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_quote_owner','b16a5dbe0a0a0bbb00043b7b284050b6','Quote Owner','action','groupList(\'u_quote_owner\');','140','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_quote_processing_allowed','b16a5dbe0a0a0bbb00043b7b284050b6','Quote Processing Allowed','action','groupList(\'u_quote_processing_allowed\');','141','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_quote_status','b16a5dbe0a0a0bbb00043b7b284050b6','Quote Status','action','groupList(\'u_quote_status\');','142','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_quoteapproved','b16a5dbe0a0a0bbb00043b7b284050b6','QuoteApproved','action','groupList(\'u_quoteapproved\');','143','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_reason_code','b16a5dbe0a0a0bbb00043b7b284050b6','Reason Code','action','groupList(\'u_reason_code\');','144','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_renewal_acv_d','b16a5dbe0a0a0bbb00043b7b284050b6','Renewal ACV','action','groupList(\'u_renewal_acv_d\');','145','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_renewal_percent_increase','b16a5dbe0a0a0bbb00043b7b284050b6','Renewal Percent Increase','action','groupList(\'u_renewal_percent_increase\');','146','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_renewal_status','b16a5dbe0a0a0bbb00043b7b284050b6','Renewal Status','action','groupList(\'u_renewal_status\');','147','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_renewal_category','b16a5dbe0a0a0bbb00043b7b284050b6','Renewal category','action','groupList(\'u_renewal_category\');','148','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sap_contract_id','b16a5dbe0a0a0bbb00043b7b284050b6','SAP Contract ID','action','groupList(\'u_sap_contract_id\');','149','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sap_contract_id_req_status','b16a5dbe0a0a0bbb00043b7b284050b6','SAP Contract ID Req Status','action','groupList(\'u_sap_contract_id_req_status\');','150','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sap_manual_override','b16a5dbe0a0a0bbb00043b7b284050b6','SAP Manual Override','action','groupList(\'u_sap_manual_override\');','151','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sap_vendor_id','b16a5dbe0a0a0bbb00043b7b284050b6','SAP Vendor ID','action','groupList(\'u_sap_vendor_id\');','152','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sales_order_number','b16a5dbe0a0a0bbb00043b7b284050b6','Sales order number','action','groupList(\'u_sales_order_number\');','153','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_secondary_competitor','b16a5dbe0a0a0bbb00043b7b284050b6','Secondary Competitor','action','groupList(\'u_secondary_competitor\');','154','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_security_sales_specialist','b16a5dbe0a0a0bbb00043b7b284050b6','Security Sales Specialist(Do Not Use)','action','groupList(\'u_security_sales_specialist\');','155','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ps_engagement_manager','b16a5dbe0a0a0bbb00043b7b284050b6','Services Executive','action','groupList(\'u_ps_engagement_manager\');','156','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','short_description','b16a5dbe0a0a0bbb00043b7b284050b6','Short description','action','groupList(\'short_description\');','157','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_solution_consultant','b16a5dbe0a0a0bbb00043b7b284050b6','Solution Consultant','action','groupList(\'u_solution_consultant\');','158','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_sourced','b16a5dbe0a0a0bbb00043b7b284050b6','Sourced','action','groupList(\'u_sourced\');','159','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_split','b16a5dbe0a0a0bbb00043b7b284050b6','Split','action','groupList(\'u_split\');','160','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_split_with','b16a5dbe0a0a0bbb00043b7b284050b6','Split with','action','groupList(\'u_split_with\');','161','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_link_reason','b16a5dbe0a0a0bbb00043b7b284050b6','Stage 9 reason','action','groupList(\'u_link_reason\');','162','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_start_date___date_dimension','b16a5dbe0a0a0bbb00043b7b284050b6','Start Date - Date Dimension','action','groupList(\'u_start_date___date_dimension\');','163','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_stop_renewal_notification','b16a5dbe0a0a0bbb00043b7b284050b6','Stop Renewal Notification','action','groupList(\'u_stop_renewal_notification\');','164','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_support_partner','b16a5dbe0a0a0bbb00043b7b284050b6','Support Partner','action','groupList(\'u_support_partner\');','165','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_contract_duration','b16a5dbe0a0a0bbb00043b7b284050b6','Term','action','groupList(\'u_contract_duration\');','166','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_term_months_and_days','b16a5dbe0a0a0bbb00043b7b284050b6','Term Months and Days','action','groupList(\'u_term_months_and_days\');','167','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_term','b16a5dbe0a0a0bbb00043b7b284050b6','Term New','action','groupList(\'u_term\');','168','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_termination_for_convenience','b16a5dbe0a0a0bbb00043b7b284050b6','Termination for Convenience','action','groupList(\'u_termination_for_convenience\');','169','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_total_acv_a','b16a5dbe0a0a0bbb00043b7b284050b6','Total ACV','action','groupList(\'u_total_acv_a\');','170','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_total_acv_and_rec_services','b16a5dbe0a0a0bbb00043b7b284050b6','Total ACV and Rec Services','action','groupList(\'u_total_acv_and_rec_services\');','171','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_total_annual_list_price','b16a5dbe0a0a0bbb00043b7b284050b6','Total Annual List Price','action','groupList(\'u_total_annual_list_price\');','172','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_license_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Total License Value','action','groupList(\'u_ssa_rollup_license_amount\');','173','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_netnewacv_a','b16a5dbe0a0a0bbb00043b7b284050b6','Total Net New ACV','action','groupList(\'u_ssa_rollup_netnewacv_a\');','174','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_other_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Total Other Revenue','action','groupList(\'u_ssa_rollup_other_amount\');','175','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_serv_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Total PS Revenue','action','groupList(\'u_ssa_rollup_serv_amount\');','176','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_ttl_serv_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Total Services Revenue','action','groupList(\'u_ssa_rollup_ttl_serv_amount\');','177','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_acv_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Total Subscription ACV','action','groupList(\'u_ssa_rollup_acv_amount\');','178','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_train_amount','b16a5dbe0a0a0bbb00043b7b284050b6','Total Training Revenue','action','groupList(\'u_ssa_rollup_train_amount\');','179','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','total_value','b16a5dbe0a0a0bbb00043b7b284050b6','Total value(total_value)','action','groupList(\'total_value\');','180','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_total_value_a','b16a5dbe0a0a0bbb00043b7b284050b6','Total value(u_total_value_a)','action','groupList(\'u_total_value_a\');','181','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_annual_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','USD Annual Revenue','action','groupList(\'u_usd_annual_revenue\');','182','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_discount_price_per_serve','b16a5dbe0a0a0bbb00043b7b284050b6','USD Discount price per server','action','groupList(\'u_usd_discount_price_per_serve\');','183','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_discount_seat_price','b16a5dbe0a0a0bbb00043b7b284050b6','USD Discount seat price','action','groupList(\'u_usd_discount_seat_price\');','184','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_gross_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','USD Gross Price Per Seat','action','groupList(\'u_usd_gross_price_per_seat\');','185','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_gross_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','USD Gross Price Per Server','action','groupList(\'u_usd_gross_price_per_server\');','186','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_matrix_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','USD Matrix price per seat','action','groupList(\'u_usd_matrix_price_per_seat\');','187','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_matrix_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','USD Matrix price per server','action','groupList(\'u_usd_matrix_price_per_server\');','188','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_net_new_acv','b16a5dbe0a0a0bbb00043b7b284050b6','USD Net new ACV','action','groupList(\'u_usd_net_new_acv\');','189','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_net_price_per_seat','b16a5dbe0a0a0bbb00043b7b284050b6','USD Net price per seat','action','groupList(\'u_usd_net_price_per_seat\');','190','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_net_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','USD Net price per server','action','groupList(\'u_usd_net_price_per_server\');','191','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_other_discount','b16a5dbe0a0a0bbb00043b7b284050b6','USD Other discount','action','groupList(\'u_usd_other_discount\');','192','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_other_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','USD Other revenue','action','groupList(\'u_usd_other_revenue\');','193','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_ps_rec_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','USD PS Rec revenue','action','groupList(\'u_usd_ps_rec_revenue\');','194','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_ps_revenue','b16a5dbe0a0a0bbb00043b7b284050b6','USD PS Revenue','action','groupList(\'u_usd_ps_revenue\');','195','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_partner_rev_usd','b16a5dbe0a0a0bbb00043b7b284050b6','USD Partner Revenue','action','groupList(\'u_ssa_rollup_partner_rev_usd\');','196','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_price_per_server','b16a5dbe0a0a0bbb00043b7b284050b6','USD Price Per Server','action','groupList(\'u_usd_price_per_server\');','197','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_renewal_acv','b16a5dbe0a0a0bbb00043b7b284050b6','USD Renewal ACV','action','groupList(\'u_usd_renewal_acv\');','198','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_total_acv','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total ACV','action','groupList(\'u_usd_total_acv\');','199','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_total_annual_list_price','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Annual List Price','action','groupList(\'u_usd_total_annual_list_price\');','200','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_license_val_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total License Value','action','groupList(\'u_ssa_rollup_license_val_usd_a\');','201','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_netnewacv_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Net New ACV','action','groupList(\'u_ssa_rollup_netnewacv_usd_a\');','202','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_other_rev_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Other Revenue','action','groupList(\'u_ssa_rollup_other_rev_usd_a\');','203','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_serv_rev_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total PS Revenue','action','groupList(\'u_ssa_rollup_serv_rev_usd_a\');','204','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_ttl_serv_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Services Revenue','action','groupList(\'u_ssa_rollup_ttl_serv_usd_a\');','205','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_acv_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Subscription ACV','action','groupList(\'u_ssa_rollup_acv_usd_a\');','206','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_train_rev_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Training Revenue','action','groupList(\'u_ssa_rollup_train_rev_usd_a\');','207','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_netnewacv_w_usd_a','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total Weighted ACV','action','groupList(\'u_ssa_rollup_netnewacv_w_usd_a\');','208','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_total_value','b16a5dbe0a0a0bbb00043b7b284050b6','USD Total value','action','groupList(\'u_usd_total_value\');','209','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_usd_weighted_acv','b16a5dbe0a0a0bbb00043b7b284050b6','USD Weighted ACV','action','groupList(\'u_usd_weighted_acv\');','210','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sys_updated_by','b16a5dbe0a0a0bbb00043b7b284050b6','Updated by','action','groupList(\'sys_updated_by\');','211','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_updated_to_contract','b16a5dbe0a0a0bbb00043b7b284050b6','Updated to Contract','action','groupList(\'u_updated_to_contract\');','212','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sys_mod_count','b16a5dbe0a0a0bbb00043b7b284050b6','Updates','action','groupList(\'sys_mod_count\');','213','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_upsell_percent_increase','b16a5dbe0a0a0bbb00043b7b284050b6','Upsell Percent Increase','action','groupList(\'u_upsell_percent_increase\');','214','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_use_line_items','b16a5dbe0a0a0bbb00043b7b284050b6','Use Line Items','action','groupList(\'u_use_line_items\');','215','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_weighted_percentage','b16a5dbe0a0a0bbb00043b7b284050b6','Weighted percentage','action','groupList(\'u_weighted_percentage\');','216','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_ssa_rollup_training_rev','b16a5dbe0a0a0bbb00043b7b284050b6','u_ssa_rollup_training_rev','action','groupList(\'u_ssa_rollup_training_rev\');','217','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_auto_renewal_flag','b16a5dbe0a0a0bbb00043b7b284050b6','zzzAuto-Renew','action','groupList(\'u_auto_renewal_flag\');','218','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_fsi_partner','b16a5dbe0a0a0bbb00043b7b284050b6','zzzFSI Partner','action','groupList(\'u_fsi_partner\');','219','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_gpp_driven','b16a5dbe0a0a0bbb00043b7b284050b6','zzzGPP Driven','action','groupList(\'u_gpp_driven\');','220','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_partner_influencer','b16a5dbe0a0a0bbb00043b7b284050b6','zzzGSI Partner','action','groupList(\'u_partner_influencer\');','221','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_deal_registration','b16a5dbe0a0a0bbb00043b7b284050b6','zzzOpportunity Registration Name','action','groupList(\'u_deal_registration\');','222','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_channel_manager','b16a5dbe0a0a0bbb00043b7b284050b6','zzzPartner Manager','action','groupList(\'u_channel_manager\');','223','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','partnership_type','b16a5dbe0a0a0bbb00043b7b284050b6','zzzPartnership type','action','groupList(\'partnership_type\');','224','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_route_to_market','b16a5dbe0a0a0bbb00043b7b284050b6','zzzRoute to Market','action','groupList(\'u_route_to_market\');','225','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','sales_partner','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSales partner','action','groupList(\'sales_partner\');','226','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_secondary_deal_registraion_n','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSecondary Opportunity Registration Name','action','groupList(\'u_secondary_deal_registraion_n\');','227','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_secondary_deal_registraion_s','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSecondary Opportunity Registration Status','action','groupList(\'u_secondary_deal_registraion_s\');','228','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_secondary_partner','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSecondary Partner','action','groupList(\'u_secondary_partner\');','229','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_secondary_partner_manager','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSecondary Partner Manager','action','groupList(\'u_secondary_partner_manager\');','230','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_seconady_partnership_type','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSecondary Partnership type','action','groupList(\'u_seconady_partnership_type\');','231','','false');
    list.titleMenu.add('b179cdcb0a0a0bbb0042ab71456d775d','u_secodary_sales_partner','b16a5dbe0a0a0bbb00043b7b284050b6','zzzSecondary Sales partner','action','groupList(\'u_secodary_sales_partner\');','232','','false');
    list.titleMenu.add('385f79170a0a0b7c001c5cbbe69fc175','10','385356ad0a0a0b7c00b3d75ea03e5eb4','10 rows per page','action','showRowsPerPage(\&quot;10\&quot;);','10','','false');
    list.titleMenu.add('385f79170a0a0b7c001c5cbbe69fc175','15','385356ad0a0a0b7c00b3d75ea03e5eb4','15 rows per page','action','showRowsPerPage(\&quot;15\&quot;);','15','','false');
    list.titleMenu.add('385f79170a0a0b7c001c5cbbe69fc175','20','385356ad0a0a0b7c00b3d75ea03e5eb4','20 rows per page','action','showRowsPerPage(\&quot;20\&quot;);','20','images/checked.pngx','false');
    list.titleMenu.add('385f79170a0a0b7c001c5cbbe69fc175','50','385356ad0a0a0b7c00b3d75ea03e5eb4','50 rows per page','action','showRowsPerPage(\&quot;50\&quot;);','50','','false');
    list.titleMenu.add('create_favorite','create_favorite', '','Create Favorite','action','showCreateFavoriteModal()','2000','','false');
...
}if (list &amp;&amp; list.getRelated() &amp;&amp; list.titleMenu &amp;&amp; GlideList2.listsMap){ list.setupRelatedListContextMenuItems(); }var list = GlideList2.get('list_opportunity');
list.headerMenu.clear();list.headerMenu.add('41a60a53471331004695d7527c9a7164','41a60a53471331004695d7527c9a7164','d1ad2f010a0a0b3e005c8b7fbd7c4e28','Export Set','action','','500','','false');
    list.headerMenu.add('4777ca1a0a0a0b285aea03289279ca97','4777ca1a0a0a0b285aea03289279ca97','','','line','','1017','','false');
    list.headerMenu.add('5402b80e9fa322005cf3ffa4677fcf10','5402b80e9fa322005cf3ffa4677fcf10','d1ad2f010a0a0b3e005c8b7fbd7c4e28','JSON','action','','350','','false');
    list.headerMenu.add('731a31e7bf460100e628555b3f073957','731a31e7bf460100e628555b3f073957','','','line','','1300','','false');
    list.headerMenu.add('8be9fda7bf460100e628555b3f07397b','8be9fda7bf460100e628555b3f07397b','','Import','action','','1042','','false');
    list.headerMenu.add('a2c38e980a0a0b3000d5190f4752094c','a2c38e980a0a0b3000d5190f4752094c','','Configure','menu','','1040','','false');
    list.headerMenu.add('ab7f76d70ad33702005f177f6d3a7145','ab7f76d70ad33702005f177f6d3a7145','','Sort (a to z)','action','','1000','','false');
    list.headerMenu.add('ab8369ac0ad337020058ada2a743863a','ab8369ac0ad337020058ada2a743863a','','Sort (z to a)','action','','1010','','false');
    list.headerMenu.add('ab845d300ad33702008cbf08895d727b','ab845d300ad33702008cbf08895d727b','','','line','','1030','','false');
    ...
    list.headerMenu.add('c28441330a0a0b3e009ac756d9348c5a','c28441330a0a0b3e009ac756d9348c5a','a2c38e980a0a0b3000d5190f4752094c','List Control','action','','30','','false');
    list.headerMenu.add('c8c2eae10a0004e30084537138ba00ed','c8c2eae10a0004e30084537138ba00ed','','Expand/Collapse All','action','','500','','true');
    list.headerMenu.add('cc97e1240a0a0b3e004a493f398feef8','cc97e1240a0a0b3e004a493f398feef8','','Bar Chart','action','','1020','','false');
    list.headerMenu.add('ccb397090a0a0b3e00b2ce638f5d6df0','ccb397090a0a0b3e00b2ce638f5d6df0','','Pie Chart','action','','1025','','false');
    list.headerMenu.add('d11613000a0a0b3e007fb501ef22352e','d11613000a0a0b3e007fb501ef22352e','','Import XML','action','','1200','','false');
    list.headerMenu.add('d175b50d0a0a0b3e002a9f1656c89d22','d175b50d0a0a0b3e002a9f1656c89d22','','Show XML','action','','1210','','false');
    list.headerMenu.add('d1ad2f010a0a0b3e005c8b7fbd7c4e28','d1ad2f010a0a0b3e005c8b7fbd7c4e28','','Export','menu','','1045','','false');
    list.headerMenu.add('d1cd92f20a0a0b3e00b44ff90470380e','d1cd92f20a0a0b3e00b44ff90470380e','d1ad2f010a0a0b3e005c8b7fbd7c4e28','CSV','action','','200','','false');
    list.headerMenu.add('d1ceb4790a0a0b3e0086e9a19b8d9657','d1ceb4790a0a0b3e0086e9a19b8d9657','d1ad2f010a0a0b3e005c8b7fbd7c4e28','XML','action','','300','','false');
    list.headerMenu.add('d1e5d8a50a0a0b3e00459c252c81e649','d1e5d8a50a0a0b3e00459c252c81e649','d1ad2f010a0a0b3e005c8b7fbd7c4e28','PDF','menu','','400','','false');
    list.headerMenu.add('d1e68f410a0a0b3e002c9785414de051','d1e68f410a0a0b3e002c9785414de051','d1e5d8a50a0a0b3e00459c252c81e649','Portrait','action','','100','','false');
    ...
    list.headerMenu.add('f13f0041473012003db6d7527c9a71f0','f13f0041473012003db6d7527c9a71f0','d1ad2f010a0a0b3e005c8b7fbd7c4e28','Excel (.xlsx)','action','','100','','false');
    list.headerMenu.add('f55d57090a0a0b3e00ca9bf67d92fc0e','f55d57090a0a0b3e00ca9bf67d92fc0e','','','line','','1190','','false');
    list.headerMenu.add('1895ef3407201000e8735720e1021eda','data_policies','a2c38e980a0a0b3000d5190f4752094c','Data Policies','action','showDataPolicies(\'model_table=sales_opportunity\');','110','','false');
    list.headerMenu.add('330107128f01200072a89cfde0f923c4','ui_actions','a2c38e980a0a0b3000d5190f4752094c','Notifications','action','showUIActions(\'collection=sales_opportunity\');','125','','false');
    list.headerMenu.add('3f629b670a0a0bd501d3310795df264a','personalize_all','a2c38e980a0a0b3000d5190f4752094c','All','action','personalizeAll(\'sales_opportunity\', \'Opportunities\');','50','','false');
    list.headerMenu.add('463d0a00ff220000dadad1cb127f9dc3','security_rules','a2c38e980a0a0b3000d5190f4752094c','Security Rules','action','showSecurityRules(\'sales_opportunity\');','70','','false');
    list.headerMenu.add('96b2f2ebd71231008d7dc23c5e61031f','workflows','a2c38e980a0a0b3000d5190f4752094c','Workflows','action','showWorkflows(\'table=sales_opportunity^template=false\');','85','','false');
    list.headerMenu.add('a3a9bf900a0a0b300030941abc7b2697','business_rules','a2c38e980a0a0b3000d5190f4752094c','Business Rules','action','showBusinessRules(\'collection=sales_opportunity\');','80','','false');
    list.headerMenu.add('c114e6d10a0a0b3e0032ce8cea45faff','client_scripts','a2c38e980a0a0b3000d5190f4752094c','Client Scripts','action','showClientScripts(\'table=sales_opportunity\');','90','','false');
    list.headerMenu.add('c11e69b40a0a0b3e00bd78e48646fb7f','ui_policies','a2c38e980a0a0b3000d5190f4752094c','UI Policies','action','showUIPolicies(\'table=sales_opportunity\');','100','','false');
    list.headerMenu.add('c120f2730a0a0b3e00a2cca96313f847','ui_actions','a2c38e980a0a0b3000d5190f4752094c','UI Actions','action','showUIActions(\'table=sales_opportunity\');','120','','false');
    list.headerMenu.add('c1228d760a0a0b3e00046e56dbd30d49','dictionary','a2c38e980a0a0b3000d5190f4752094c','Dictionary','action','showDictionary(\'name=sales_opportunity\');','130','','false');
    list.headerMenu.add('e4ce64f0c3303000bac1addbdfba8f42','dictionary','a2c38e980a0a0b3000d5190f4752094c','Table','action','showTable(\'sales_opportunity\');','60','','false');
    var list = GlideList2.get('list_opportunity');
list.rowMenu.clear();list.rowMenu.add('3dce86d3c0a800664664155da3434875','3dce86d3c0a800664664155da3434875','','Assign Tag','menu','','95','','false');
    list.rowMenu.add('eaeb7ec50a0a0b3e00e0a8a429344e86','eaeb7ec50a0a0b3e00e0a8a429344e86','','Copy sys_id','action','','50','','false');
    list.rowMenu.add('eb6c4d1b0a0a0b3e0029fbb8fee7a7a8','eb6c4d1b0a0a0b3e0029fbb8fee7a7a8','','','line','','30','','false');
    list.rowMenu.add('eeca263ac0a80066000245d1d9169203','eeca263ac0a80066000245d1d9169203','','','line','','90','','false');
    list.rowMenu.add('31eb887b13465640daf93227d144b058','--email--','d3e7c07f13465640daf93227d144b0a3','Email','action','assignNewLabelAction(\'Email\')','100','','false');
    list.rowMenu.add('31eb887b13465640daf93227d144b058','--emailresponse--','d3e7c07f13465640daf93227d144b0a3','Email Response','action','assignNewLabelAction(\'Email Response\')','101','','false');
    list.rowMenu.add('31eb887b13465640daf93227d144b058','--socialoutreach--','d3e7c07f13465640daf93227d144b0a3','Note','action','assignNewLabelAction(\'Note\')','102','','false');
    list.rowMenu.add('31eb887b13465640daf93227d144b058','--phonecall--','d3e7c07f13465640daf93227d144b0a3','Phone Call','action','assignNewLabelAction(\'Phone Call\')','103','','false');
    list.rowMenu.add('31eb887b13465640daf93227d144b058','--scheduled--','d3e7c07f13465640daf93227d144b0a3','Schedule - Follow Up','action','assignNewLabelAction(\'Schedule - Follow Up\')','104','','false');
    list.rowMenu.add('31eb887b13465640daf93227d144b058','--socialoutreach--','d3e7c07f13465640daf93227d144b0a3','Social Outreach','action','assignNewLabelAction(\'Social Outreach\')','105','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Email','ad43c018db87e6004a54f4bbaf96197b','Email','action','assignNewLabelAction(\'Email\')','100','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Email Response','ad43c018db87e6004a54f4bbaf96197b','Email Response','action','assignNewLabelAction(\'Email Response\')','101','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Note','ad43c018db87e6004a54f4bbaf96197b','Note','action','assignNewLabelAction(\'Note\')','102','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Phone Call','ad43c018db87e6004a54f4bbaf96197b','Phone Call','action','assignNewLabelAction(\'Phone Call\')','103','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Phone Call - Contacted','ad43c018db87e6004a54f4bbaf96197b','Phone Call - Contacted','action','assignNewLabelAction(\'Phone Call - Contacted\')','104','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Schedule - Follow Up','ad43c018db87e6004a54f4bbaf96197b','Schedule - Follow Up','action','assignNewLabelAction(\'Schedule - Follow Up\')','105','','false');
    list.rowMenu.add('7a590050dbc7e6004a54f4bbaf9619e5','Social Outreach','ad43c018db87e6004a54f4bbaf96197b','Social Outreach','action','assignNewLabelAction(\'Social Outreach\')','106','','false');list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','--newTag--','3dce86d3c0a800664664155da3434875','New Tag...','action','assignNewLabelAction()','100','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Model Financial Configurations','action','assignLabelAction(\'Model Financial Configurations\')','101','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Consumable Models','action','assignLabelAction(\'Consumable Models\')','102','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Regular Employee Offboard','action','assignLabelAction(\'Regular Employee Offboard\')','103','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Custom Interactive Filter','action','assignLabelAction(\'Custom Interactive Filter\')','104','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','LinkedIn','action','assignLabelAction(\'LinkedIn\')','105','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Compensation','action','assignLabelAction(\'Compensation\')','106','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Onboarding','action','assignLabelAction(\'Onboarding\')','107','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','assign_label','3dce86d3c0a800664664155da3434875','Contingent Workers','action','assignLabelAction(\'Contingent Workers\')','108','','false');
    list.rowMenu.add('eb7353310a0a0b3e0067aebf230c81db','--moreTags--','3dce86d3c0a800664664155da3434875','More...','action','promptWithMoreTagChoices()','109','','false');
    g_list_edit_enable_property = 'true';
g_list_edit_enable = true;
g_list_edit_double = true;
g_list_edit_ignore_types = &quot;html,document_id,conditions,template_value,glide_time,currency,price,user_image,video,field_list,domain_number,domain_path,glide_list,glide_action_list,currency2&quot;;
g_list_edit_version_2 = &quot;true&quot;;
g_list_edit_grid = &quot;false&quot;;addLoadEvent(function() {addUnloadEvent(GlideList2.unload);});
addLoadEvent(function() { GlideList2.get('list_opportunity').loaded(); });
...
addLoadEvent( function() {
GlideList2.get(&quot;list_opportunity&quot;).setDefaultFilter(&quot;stageNOT INclosed_won,closed_lost,closed_no_decision,sops_admin^typeIN new_business,Renewal,Module Upsell,License Upsell^account=8fc3f7ae0a0a3cba019da3d205ede759&quot;);
});
CustomEvent.observe(&quot;list2_init&quot;, function(list) {
if ($j(list.table).find('td:first-child').length &amp;gt; 1) {
$j(list.table).find('td:first-child').each(function() {
var sys_id = $j(this).parent().attr(&quot;sys_id&quot;)
if(sys_id){
$j(this).html(&quot;&amp;lt;a onclick='selectOpportunityOnActivity(\&quot;&quot;+sys_id+&quot;\&quot;)'&amp;gt;Select&amp;lt;/a&amp;gt;&quot;)
}
});
}
});
CustomEvent.observe(&quot;frame.resized&quot;, function(gw) {
    setTimeout(function(){ setActionOKFunction(); }, 2000);
    
 
});
window.parent.CustomEvent.observe(&quot;content_frame.resized&quot;, function(gw) {
 setActionOKFunction();
});
function setActionOKFunction(){
var actionOK_str = actionOK.toString();
 actionOK_str = actionOK_str.replace(&quot;setTimeout('reloadWindow(self);', 1);&quot;,&quot;realodGlideDialog();&quot;); // replace reload line
 actionOK=new Function(&quot;return &quot;+actionOK_str)();
 $j(&quot;#ok_button&quot;).attr(&quot;onClick&quot;,&quot;actionOK();return false;&quot;) // return false to stop reloading form
}
function selectOpportunityOnActivity(sys_id) {
var sysparm_referring_url = g_form.getValue(&quot;sysparm_referring_url&quot;);
openNewPopupWindow(sys_id,sysparm_referring_url);
}
//function openNewPopupWindow(opportunityId,sysparm_referring_url) {
g_form.modified = false;
window.location='sales_opportunity.do?sys_id='+opportunityId+&quot;&amp;sysparm_referring_url=&quot;+sysparm_referring_url;
}
function realodGlideDialog(){
GlideDialogWindow.prototype.get('opportunity_creation_list').render();
}
function createOpportunity(accountId){
GlideDialogWindow.prototype.get('opportunity_creation_list').destroy();
}</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
